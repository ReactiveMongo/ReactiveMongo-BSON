...
final class SerializationSpec extends org.specs2.mutable.Specification {
  ...
  "Buffer" should {
    ...
    "skip until condition" in {
      val buf =
        WritableBuffer.empty.writeCString("foo").writeInt(13).toReadableBuffer()
    ...
    "split after n bytes" in {
      val buf =
        WritableBuffer.empty.writeInt(21).writeLong(3L).toReadableBuffer()

      buf.splitAt(4) must beLike {
        case (before, `buf`) =>
          before.readInt() must_=== 21 and {
  ...
  "BSON default serializer" should {
    def codec(expected: BSONValue): Option[BSONValue] = scala.util.Try {
      val buffer = DefaultBufferHandler
    ...
    "serialize an array" in {
      val arr =
        BSONArray(Option.empty[String], BSONBoolean(true), Option.empty[String])
    ...
    "serialize documents" >> {
      ...
      "when containing an array" in {
        ...
        val expected = Array[Byte](110, 0, 0, 0, 3, 99, 111, 110, 116, 97, 99,
          ...
          112, 108, 101, 46, 111, 114, 103, 0, 2, 49, 0, 26, 0, 0, 0, 115, 112,
      ...
      "when duplicate in binary representation" >> {
        val binRepr = Array[Byte](44, 0, 0, 0, 16, 108, 111, 114, 101, 109, 0,
          1, 0, 0, 0, 2, 102, 111, 111, 0, 4, 0, 0, 0, 98, 97, 114, 0, 1, 108,
          111, 114, 101, 109, 0, -102, -103, -103, -103, -103, -103, 11, 64, 0)
  ...
  "BSON Default Deserializer" should {
    ...
    Fragments.foreach(BSONValueFixtures.bsonJSWsFixtures) { jsWs =>
      s"de/serialize $jsWs" in {
        ...
        val readable =
          DefaultBufferHandler.serialize(jsWs, buffer).toReadableBuffer()
...
object SerializationFixtures {
  ...
  lazy val ismaster = Array[Byte](-72, 1, 0, 0, 2, 115, 101, 116, 78, 97, 109,
    101, 0, 7, 0, 0, 0, 114, 101, 97, 99, 116, 109, 0, 16, 115, 101, 116, 86,
    101, 114, 115, 105, 111, 110, 0, 3, 0, 0, 0, 8, 105, 115, 109, 97, 115, 116,
    101, 114, 0, 1, 8, 115, 101, 99, 111, 110, 100, 97, 114, 121, 0, 0, 4, 104,
    111, 115, 116, 115, 0, -122, 0, 0, 0, 2, 48, 0, 36, 0, 0, 0, 83, 116, 101,
    112, 104, 97, 110, 101, 115, 45, 77, 97, 99, 66, 111, 111, 107, 45, 80, 114,
    111, 45, 50, 46, 108, 111, 99, 97, 108, 58, 50, 55, 48, 49, 55, 0, 2, 49, 0,
    36, 0, 0, 0, 83, 116, 101, 112, 104, 97, 110, 101, 115, 45, 77, 97, 99, 66,
    111, 111, 107, 45, 80, 114, 111, 45, 50, 46, 108, 111, 99, 97, 108, 58, 50,
