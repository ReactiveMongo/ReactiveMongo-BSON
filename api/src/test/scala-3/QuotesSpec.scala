  ...
  "Product" should {
    ...
    "be created" >> {
      "from Foo" in {
        testWithTuple(
          Foo("1", 2)
        ) must_=== "scala.Tuple2[scala.Predef.String, scala.Int]/(1,2)"
      }

      "from generic Bar" in {
        testWithTuple(
          Bar[Double]("bar1", None, Seq(1.2D, 34.5D))
        ) must_=== "scala.Tuple3[scala.Predef.String, scala.Option[scala.Double], scala.collection.immutable.Seq[scala.Double]]/(bar1,None,List(1.2, 34.5))" and {
          testWithTuple(
            Bar[Float]("bar2", Some(1.23F), Seq(0D))
          ) must_=== "scala.Tuple3[scala.Predef.String, scala.Option[scala.Float], scala.collection.immutable.Seq[scala.Double]]/(bar2,Some(1.23),List(0.0))"
        }
      }
    }
